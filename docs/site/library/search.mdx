...
In All Documents the top result is selected as you type, so Return opens it; the arrow keys walk the results, and ⌘↩ opens one in Review. Esc clears the search and sends the field gliding back to its spot in the header, the way it came.
