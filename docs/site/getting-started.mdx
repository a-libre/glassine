...
<Steps>
  ...
  <Step title="See everything">
    ⌘1 (or ⌘P) opens **All Documents**, a wall of cards with a rendered preview of each document. Arrow keys move between cards, Return opens one, Esc comes back. From the editor, Esc goes the other way: the page shrinks back into its card — in All Documents, or in Timelapse if that is where you opened it.
  </Step>
  <Step title="Search">
  ...
  <Step title="Read it back">
    ⌘↩ (or ⌘⇧S) swaps the editor for **Review**: the document rendered as a finished page in one of six styles. ⌘↩ or Esc returns to the editor at about the same place.
  </Step>
