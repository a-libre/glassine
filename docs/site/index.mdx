...
<Frame caption="One page, start to finish: written, read, put away, and found again the next day.">
  <video autoPlay muted loop playsInline controls className="w-full aspect-video" poster="https://glassine.ink/film-poster.jpg" src="https://glassine.ink/film.mp4" aria-label="A 46-second film of one page in Glassine, start to finish. Captions are part of the picture."></video>
</Frame>
