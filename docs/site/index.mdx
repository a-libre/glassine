...
<Frame caption="One page, start to finish: written, read, put away, and found again the next day — to a song. The controls have the sound.">
  <video autoPlay muted loop playsInline controls className="w-full aspect-video" poster="https://glassine.ink/film-poster.jpg" src="https://glassine.ink/film.mp4" aria-label="A 46-second film of one page in Glassine, start to finish, set to a song. Captions are part of the picture."></video>
</Frame>
...
<Frame caption="The editor: an essay on dark glass, the library in a sidebar on the left.">
...
- **Review** (⌘↩): the document rendered as a page in one of six styles.
